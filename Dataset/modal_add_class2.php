		...
		<option value="8:30pm">8:30pm</option></select>
								 ...
								 <div class="control-group">
									...
									<select type="text" name="fname" class = "form-control" placeholder="Category" >
                                      <option>--Select--</option>
	<?php $teacher_query=mysqli_query($conn,"select * from teachers where department like '%SAS%'")or die(mysqli_error());
	...
	<?php } ?>
								  ...
								  <div class="control-group">
									...
									<select type="text" name="subject_code" class = "form-control" placeholder="Category" >
                                       <option>--Select--</option>
<?php $subject_query=mysqli_query($conn,"select * from subject where department like '%SAS%'")or die(mysqli_error());
 ...
 <?php } ?>
								  ...
								  <div class="control-group">
									...
									<select type="text" name="room_name" class = "form-control" placeholder="Category" >
                                        <option>--Select--</option>
	<?php $room_query=mysqli_query($conn,"select * from room where department like '%SAS%'")or die(mysqli_error());
	...
	<?php } ?>
								  ...
								  <div class="control-group">
									...
									<select type="text" name="course_year_section" class = "form-control" placeholder="Category" >
                                       <option>--Select--</option>
	<?php $CYS_query=mysqli_query($conn,"select * from course where department like '%SAS%'")or die(mysqli_error());
